 ...
 * @author hnleo
 */
public class EditarUsuariosPantalla extends JFrame {

    private Gestion gestion;

    public EditarUsuariosPantalla() {
    ...
    private void pantalla() {
        ...
        JButton crearUsuarioButton = new JButton("Editar");
            ...
            public void focusLost(FocusEvent e) {
                ...
                try {
                    if (user != null) {
                        ...
                        JOptionPane.showMessageDialog(EditarUsuariosPantalla.this, "Usuario no existe.", "ADVERTENCIA", JOptionPane.WARNING_MESSAGE);
                        textNombre.setText("");
                        usuarioText.setText("");
                ...
                JOptionPane.showMessageDialog(EditarUsuariosPantalla.this,"Error: "+i.getMessage(),"ERROR",JOptionPane.ERROR_MESSAGE);
                }
