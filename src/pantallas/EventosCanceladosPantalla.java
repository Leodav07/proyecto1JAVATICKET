 ...
 * @author hnleo
 */
public class EventosCanceladosPantalla extends JFrame {

    private JTextArea textAreaEventos;
    private JButton btnRegresar;
    private Gestion gestion;

    public EventosCanceladosPantalla() {
    ...
    public void pantalla(){    
        ...
        JLabel subtitulo = new JLabel("Listado de eventos cancelados", SwingConstants.CENTER);
        ...
        textAreaEventos.append(gestion.listadoEventosRealizados("Cancelado"));
        }catch(Exception e){
